...
class TestPS4B(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with redirect_stdout(open(os.devnull, "w")):
            ...
            self.ptmsg1 = student.PlaintextMessage(self.text1, 3)
            self.ptmsg2 = student.PlaintextMessage(self.text2, 1)
    ...
    def test_message_build_shift_dict(self):
        sd1 = self.msg1.build_shift_dict(0)
        ...
        sd2 = self.msg1.build_shift_dict(4)
    ...
    def test_message_apply_shift(self):
        ...
        sd1 = self.msg1.build_shift_dict(3)
        sd2 = self.msg2.build_shift_dict(1)
        sd3 = self.msg3.build_shift_dict(2)
    ...
    def test_plaintext_message_attributes(self):
        ...
        new_ed1 = self.ptmsg1.get_encryption_dict()
        self.assertEqual(new_ed1.get('test_key',-1), -1, "get_encryption_dict() should return a copy of the encryption_dict attribute, but your code returns the original.")
    ...
    def test_plaintext_message_change_shift(self):
        ...
        self.ptmsg1.change_shift(0)

        actual_shift = self.ptmsg1.get_shift()
        self.assertEqual(0, actual_shift, "After calling change_shift(), the value of self.shift was not updated correctly: expected %s, got %s" % (0, actual_shift))
    ...
    def test_ciphertext_decrypt_message(self):
        ...
        self.assertEqual(dc1[0], 23,  error_msg_1 % (23, self.encrypt1, dc1[0]))
        self.assertEqual(dc1[1], self.text1, error_msg_2 % (self.encrypt1, self.text1, dc1))

        dc2 = self.ctmsg2.decrypt_message()
        self.assertEqual(dc2[0], 25, error_msg_1 % (25, self.encrypt2, dc2[0]))
    ...
    def test_valid_word_checking(self):
        ...
        encrypted = 'nyq, mkd,'
        expected_decrypt = 'dog, cat,'
        with redirect_stdout(open(os.devnull, "w")):
            c = student.CiphertextMessage(encrypted)
        shift, actual = c.decrypt_message()
        self.assertEqual(actual, expected_decrypt, error_msg % (16, expected_decrypt, encrypted, shift, actual))
